...
without paying you or asking for permission.</p>
          ...
          <div className="flex flex-col gap-2">
            ...
            are fields constantly changing. We&apos;re always trying to make our Services better, more accurate, 
          ...
          <p><span className="font-bold">Informal Dispute Resolution:</span> We prefer to address your concerns informally before taking legal action. Before either party files a claim against the other, we agree to attempt to resolve the dispute informally. You can do this by sending us notice to contact@experior.ai, and we will do so by contacting the email associated with your account. If we cannot resolve a dispute within 60 days, either party has the right to initiate arbitration. Both parties also agree to attend an individual settlement conference if requested during this time. Any statute of limitations will be paused during this informal resolution process.</p>
          <p><span className="font-bold">Arbitration Forum:</span> If we cannot resolve the dispute, either party may start arbitration with the Court of Chancery of Delaware under its <a className="underline" target="_blank" href="https://courts.delaware.gov/forms/download.aspx?id=160908">rules</a>. Experior will not seek attorney&apos;s fees and costs in arbitration unless the arbitrator finds your claim to be frivolous. The Federal Arbitration Act will govern these arbitration terms and any arbitration since these Terms involve interstate commerce.</p>
          <p><span className="font-bold">Arbitration Procedures:</span> The arbitration will primarily be held via videoconference, but if the arbitrator deems an in-person hearing necessary, the location will be chosen by mutual agreement, within the county of your residence, or as decided by the arbitrator, unless the batch arbitration method is applicable. A single arbitrator will oversee the arbitration. This arbitrator will either be a retired judge or a lawyer licensed to practice in Delaware. The arbitrator will have sole power to settle any Dispute, except that the Court of Chancery of Delaware or federal courts in Wilmington, Delaware, will have jurisdiction over any issues regarding the enforceability, validity of the class action waiver, or requests for public injunctive relief, as detailed below. Neither party will reveal any settlement offer amounts to the arbitrator until after the final award is determined, if applicable. The arbitrator is empowered to approve motions that resolve all or part of any Dispute. The parties may choose to adhere to the expedited procedures of the Delaware Rapid Arbitration Act for a quicker resolution.</p>
